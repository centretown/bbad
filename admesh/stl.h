...
typedef struct Vector3 stl_vertex;
// #else
// typedef struct {
//   float x;
//   float y;
...
#ifdef static_assert
static_assert(offsetof(stl_facet, normal) == 0,
              "stl_facet.normal has correct offset");
static_assert(offsetof(stl_facet, vertex) == 12,
              "stl_facet.vertex has correct offset");
static_assert(offsetof(stl_facet, extra) == 48,
              "stl_facet.extra has correct offset");
static_assert(sizeof(stl_facet) >= SIZEOF_STL_FACET,
              "size of stl_facet incorrect");
#endif
...
#ifdef static_assert
static_assert(offsetof(stl_hash_edge, facet_number) == SIZEOF_EDGE_SORT,
              "size of stl_hash_edge.key incorrect");
#endif
...
extern void stl_write_ascii(stl_file *stl, const ADMESH_CHAR *file,
                            const char *label);
extern void stl_write_binary(stl_file *stl, const ADMESH_CHAR *file,
                             const char *label);
...
extern void stl_get_transform(stl_file const *stl_src, stl_file *stl_dst,
...
extern void stl_repair(stl_file *stl, int fixall_flag, int exact_flag,
